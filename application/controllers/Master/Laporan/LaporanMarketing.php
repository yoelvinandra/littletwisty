...
class LaporanMarketing extends MY_Controller {
	...
	{		
		...
		//PERUSAHAAN
		$wherePerusahaan = "and MMARKETING.idperusahaan=$perusahaan";

		//STATUS
		$whereStatus .= "and MMARKETING.STATUS LIKE '%".$jenisStatus[0]."%'";

		$sql = "select * from mmarketing where (1=1 $whereFilter) $wherePerusahaan $whereStatus order by namamarketing asc";
		...
		$dir = 'reports/v_';
		$this->load->view($dir."report_master_marketing.php",$data);
	}
}
