...
class LaporanSupplier extends MY_Controller {
	...
	{		
		...
		//PERUSAHAAN
		$wherePerusahaan = "and MSUPPLIER.idperusahaan=$perusahaan";

		//STATUS
		$whereStatus .= "and MSUPPLIER.STATUS LIKE '%".$jenisStatus[0]."%'";
		...
		$dir = 'reports/v_';
		$this->load->view($dir."report_master_supplier.php",$data);
	}
}
