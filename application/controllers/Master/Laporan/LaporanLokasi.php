...
class LaporanLokasi extends MY_Controller {
	...
	{		
		...
		//PERUSAHAAN
		$wherePerusahaan = "and MLOKASI.idperusahaan=$perusahaan";

		//STATUS
		$whereStatus .= "and MLOKASI.STATUS LIKE '%".$jenisStatus[0]."%'";
	
		
		$sql = "select * from mlokasi where (1=1 $whereFilter) $wherePerusahaan $whereStatus order by namalokasi asc";
		...
		$dir = 'reports/v_';
		$this->load->view($dir."report_master_lokasi.php",$data);
	}
