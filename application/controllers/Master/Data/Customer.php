...
class CUSTOMER extends MY_Controller {
	...
	public function simpan(){
		...
		$data_values = array (
			...
			'ALAMATFAKTURPAJAK'     => $this->input->post('ALAMATFAKTURPAJAK')??"",
			'KOTAFAKTURPAJAK'       => $this->input->post('KOTAFAKTURPAJAK')??"",
			'PROVINSIFAKTURPAJAK'   => $this->input->post('PROVINSIFAKTURPAJAK')??"",
			'NEGARAFAKTURPAJAK'     => $this->input->post('NEGARAFAKTURPAJAK')??"",
