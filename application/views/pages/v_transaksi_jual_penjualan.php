...
$(document).ready(function(){
    ...
    $.ajax({
		...
		data    : {state:1,status:'UNPAID,READY_TO_SHIP,PROCESSED,IN_CANCEL',tglawal:"<?=TGLAWALFILTERMARKETPLACE?>",tglakhir:$("#TGLTRANS").val()},
		dataType: 'json',
		success : function(msg){
		    if(msg.rows.length > 0)
		    { 
		        $("#notifShopee").addClass("circle-icon");
		    }
	}});
