        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Penyesuaian Stok </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanPenyesuaianStok" action='<?=base_url()?>Inventori/Laporan/LaporanPenyesuaianStok/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
													...
													<div id="hide_nilai_list_penyesuaian_stok_persediaan">
														<select id="txt_nilai_list_penyesuaian_stok_persediaan" name="txt_nilai_list_penyesuaian_stok_persediaan"  class="form-control select2"  style="width:97%;" prompt="Nilai"/>
															<?=comboGrid("model_inventori_penyesuaian")?>
														</select>
													</div>
                                        ...
                                        <div class="form-group col-sm-4">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP','Laporan Rekap Penyesuaian Stok')" style="cursor:pointer">
                                            ...
                                            <div class="info-box bg-yellow" onclick="simpan('REGISTER','Laporan Penyesuaian Stok')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>
											...
											<div class="info-box bg-yellow" onclick="simpan('REGISTERBARANG','Laporan Penyesuaian Stok Per Barang')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanPenyesuaianStok">
...
$("#btn_add").click(function(){
	...
	{
		nilai = $('#txt_nilai_list_penyesuaian_stok_persediaan').val();
		if (nilai != "" && nilai != null) 
		{
			checknilai = 1;
		}
...
function simpan(modeSimpan,tabLaporan) {
    ...
    if(modeSimpan == "REKAP")
    {
      label = "PENYESUAIAN_STOK_REKAP_";
    }
    else if(modeSimpan == "REGISTER")
    {
      label = "PENYESUAIAN_STOK_";
    }
    else
    {
      label = "PENYESUAIAN_STOK_BARANG_";  
    }
