        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Posisi Stok </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanPosisiStok" action='<?=base_url()?>Inventori/Laporan/LaporanPosisiStok/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-8">
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="txt_tgl_transaksi"  name="txt_tgl_ak" style="width:97%; border:1px solid #B5B4B4; border-radius:5px;">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2 " id="kolom" name="kolom" placeholder="Kolom" style="width:97%;">
														...
														<option value="SUM(c.JML)">Stok</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group col-sm-4">
											<h4 class="box-title">
												<b>Jenis Laporan</b>	 
											</h4><div class=" form-group" style="font-weight:bold;"><label><input type="checkbox" id="cbStokPerLokasi" name="cbStokPerLokasi" value="1" class="flat-blue"> Stok per Lokasi </label></div>
											...
											<div class="info-box bg-yellow" onclick="simpan('POSISISTOKSIZE','Laporan Posisi Stok Per Ukuran')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>

												<div class="info-box-content">
												   <span class="info-box-number">Laporan Posisi Stok Per Ukuran</span>
												</div>
												<!-- /.info-box-content -->
											</div>
                                            <div class="info-box bg-yellow" onclick="simpan('POSISISTOK','Laporan Posisi Stok')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>

												<div class="info-box-content">
												   <span class="info-box-number">Laporan Posisi Stok</span>
												</div>
												<!-- /.info-box-content -->
											</div>
											<!--<div class="info-box bg-yellow" onclick="simpan('POSISISTOKLOKASI','Laporan Posisi Stok Lokasi')" style="cursor:pointer;">-->
											<!--	<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>-->

											<!--	<div class="info-box-content">-->
											<!--	   <span class="info-box-number">Laporan Posisi Stok Lokasi</span>-->
											<!--	   <span>Menampilkan posisi stok dari transaksi yang pernah dibuat berdasarkan lokasi.</span>-->
											<!--	</div>-->
												<!-- /.info-box-content -->
											<!--</div>-->
                                        </div>
...
function simpan(modeSimpan,tabLaporan) {
    var label = "";
    if(modeSimpan == "POSISISTOK"){
        label = "STOK";
    }
    else if(modeSimpan == "POSISISTOKLOKASI"){
        label = "STOK_LOKASI";
    }
    else
    {
    ...
    $("#file_name").val("POSISI_"+label+"_"+dateNowFormatExcel());
    var arraySimpan = [];
