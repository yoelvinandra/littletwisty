        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Saldo Stok </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanSaldoStok" action='<?=base_url()?>Inventori/Laporan/LaporanSaldoAwal/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-8">
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2 " id="kolom" name="kolom" placeholder="Kolom" style="width:97%;">
                                                        <option value="SALDOSTOK.KODESALDOSTOK">Kode Saldo Stok</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
													...
													<div id="hide_nilai_list_saldo_stok">
														<select id="txt_nilai_list_saldo_stok" name="txt_nilai_list_saldo_stok"  class="form-control select2"  style="width:97%;" prompt="Nilai"/>
															<?=comboGrid("model_inventori_saldo_awal")?>
														</select>
													</div>
                                        ...
                                        <div class="form-group col-sm-4">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP','Laporan Rekap Saldo Stok')" style="cursor:pointer">
                                            ...
                                            <div class="info-box bg-yellow" onclick="simpan('REGISTER','Laporan Saldo Stok')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>
											...
											<div class="info-box bg-yellow" onclick="simpan('REGISTERLOKASI','Laporan Saldo Stok Per Lokasi')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>

												<div class="info-box-content">
												   <span class="info-box-number">Laporan Register Lokasi</span>
												</div>
												<!-- /.info-box-content -->
											</div>
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanSaldoStok">
...
var kolom = "Kode Saldo Stok";
var namaKolom = "Saldo Stok";
var kolomVal = "SALDOSTOK.KODESALDOSTOK"
var checkData = "Kode";
var operator = "Adalah";
...
$("#kolom").change(function() {
		...
		if(checkData == "Kode" || checkData == "Nama" )
		{
			...
			if(namaKolom == 'Produk')
			{
				...
				$('#hide_nilai_list_saldo_stok').hide();
			}
...
$("#btn_add").click(function(){
	...
	else if(namaKolom == 'Saldo Stok' && (operator == "Adalah" || operator == "Tidak mencakup"))
	{
		nilai = $('#txt_nilai_list_saldo_stok').val();
        if (nilai != "" && nilai != null) {
            checknilai = 1;
        }
	}
