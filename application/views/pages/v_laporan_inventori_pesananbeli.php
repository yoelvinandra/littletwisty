        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Purchase Order </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanPesanan" action='<?=base_url()?>Inventori/Laporan/LaporanPO/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2" multiple="multiple" id="cbStatus" name="cbStatus[]" style="width:97%;">
                                                        ...
                                                        <option value="C" selected>Sebagian</option>
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2 " id="kolom" name="kolom" placeholder="Kolom" style="width:97%;">
                                                        <option value="TPO.KODEPO">Kode Purchase Order</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div id="hide_nilai_list_po">
														<select id="txt_nilai_list_po" name="txt_nilai_list_po" class="form-control select2" style="width:97%;" prompt="Nilai"/>
															<?=comboGrid("model_inventori_pesananbeli")?>
														</select>
													</div>
													<div id="hide_nilai_list_supplier" style="display:none;">
														<select id="txt_nilai_list_supplier" name="txt_nilai_list_supplier" class="form-control select2" style="width:97%;" prompt="Nilai"/>
															<?=comboGrid("model_master_supplier")?>
														</select>
													</div>
													<div id="hide_nilai_list_barang" style="display:none;">
														<select id="txt_nilai_list_barang" name="txt_nilai_list_barang" class="form-control select2" style="width:97%;" prompt="Nilai"/>
                                        ...
                                        <div class="form-group col-sm-4">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP','Laporan Rekap Pesanan')" style="cursor:pointer">
                                            ...
                                            <div class="info-box bg-yellow" onclick="simpan('REGISTER','Laporan Register Pesanan')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanPesanan">
...
var kolom = "Kode Purchase Order";
var namaKolom = "Purchase Order";
var kolomVal = "TPO.KODEPO"
var checkData = "Kode";
var operator = "Adalah";
...
//FILTER KOLOM
	$("#kolom").change(function() {
		...
		if(checkData == "Kode" || checkData == "Nama" )
		{
			...
			else if(namaKolom == 'Purchase Order')
			{
				$('#hide_nilai_list_supplier').hide();
				$('#hide_nilai_list_barang').hide();
				$('#hide_nilai_list_po').show();
			}
	...
	$("#btn_add").click(function() {
        ...
        }else if (namaKolom == 'Purchase Order' && (operator == "Adalah" || operator == "Tidak mencakup")) {
            nilai = $('#txt_nilai_list_po').val();
            if (nilai != "" && nilai != null ) {
                checknilai = 1;
            }
    ...
    function simpan(modeSimpan,tabLaporan) {
        $("#file_name").val("PESANAN_"+modeSimpan+"_"+dateNowFormatExcel());
        var arraySimpan = [];
