        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Master Marketing </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanMarketing" action='<?=base_url()?>Master/Laporan/LaporanMarketing/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2 " id="kolom" name="kolom" placeholder="Kolom" style="width:97%;">
                                                        <option value="MMARKETING.KODEMARKETING">Kode Marketing</option>
														<option value="MMARKETING.NAMAMARKETING">Nama Marketing</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                   ...
                                                   <div id="hide_nilai_list_marketing">
														<select id="txt_nilai_list_marketing" class="form-control select2" name="txt_nilai_list_marketing" style="width:97%" prompt="Nilai"/>
															<?=comboGrid("model_master_marketing")?>
														</select>
													</div>
                                        ...
                                        <div class="form-group col-sm-6">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP')" style="cursor:pointer">
												...
												<div class="info-box-content">
												  <span class="info-box-number">Laporan Marketing</span>
												  <span>Menampilkan data dari marketing yang sudah pernah dibuat.</span>
												</div>
												<!-- /.info-box-content -->
											</div>	
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanMarketing">
...
var kolom = "Kode Marketing";
var namaKolom = "Marketing";
var kolomVal = "MMARKETING.KODEMARKETING"
var checkData = "Kode";
var operator = "Adalah";
...
$("#btn_add").click(function(){
	...
	if(namaKolom == 'Marketing' && (operator == "Adalah" || operator == "Tidak mencakup"))
	{
		var value = $('#txt_nilai_list_marketing').val().split(" | ");
