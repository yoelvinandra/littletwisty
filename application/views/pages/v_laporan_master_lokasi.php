        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Lokasi </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanLokasi" action='<?=base_url()?>Master/Laporan/LaporanLokasi/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2 " id="kolom" name="kolom" placeholder="Kolom" style="width:97%;">
                                                        <option value="MLOKASI.KODELOKASI">Kode Lokasi</option>
														<option value="MLOKASI.NAMALOKASI">Nama Lokasi</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                   ...
                                                   <div id="hide_nilai_list_lokasi">
														<select id="txt_nilai_list_lokasi" class="form-control select2" name="txt_nilai_list_lokasi" style="width:97%" prompt="Nilai"/>
                                        ...
                                        <div class="form-group col-sm-6">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP')" style="cursor:pointer">
												...
												<div class="info-box-content">
												  <span class="info-box-number">Laporan Lokasi</span>
												  <span>Menampilkan data dari lokasi yang sudah pernah dibuat.</span>
												</div>
												<!-- /.info-box-content -->
											</div>	
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanLokasi">
...
var kolom = "Kode Lokasi";
var namaKolom = "Lokasi";
var kolomVal = "MLOKASI.KODELOKASI"
var checkData = "Kode";
var operator = "Adalah";
...
$("#btn_add").click(function(){
	...
	if(namaKolom == 'Lokasi' && (operator == "Adalah" || operator == "Tidak mencakup"))
	{
			
		if(checkData == "Kode") nilai = $('#txt_nilai_list_lokasi').val();
		else if(checkData == "Nama") nilai = $('#txt_nilai_list_lokasi option:selected').text();
