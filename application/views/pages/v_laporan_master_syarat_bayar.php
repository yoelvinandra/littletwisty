        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Master Syarat Bayar </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanSyaratBayar" action='<?=base_url()?>Master/Laporan/LaporanSyaratBayar/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                   ...
                                                   <div id="hide_nilai_list_syarat_bayar">
														<select id="txt_nilai_list_syarat_bayar" class="form-control select2" name="txt_nilai_list_syarat_bayar" style="width:97%" prompt="Nilai"/>
                                        ...
                                        <div class="form-group col-sm-6">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP')" style="cursor:pointer">
												...
												<div class="info-box-content">
												  <span class="info-box-number">Laporan Syarat Bayar</span>
												  <span>Menampilkan syarat pembayaran dari pembelian yang sudah pernah dibuat.</span>
												</div>
												<!-- /.info-box-content -->
											</div>	
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanSyaratBayar">
...
var kolom = "Kode Syarat Bayar";
var namaKolom = "Syarat Bayar";
var kolomVal = "MSYARATBAYAR.KODESYARATBAYAR"
var checkData = "Kode";
var operator = "Adalah";
...
$("#kolom").change(function() {
		...
		if(checkData == "Kode" || checkData == "Nama" )
		{
			...
			if(namaKolom == 'Syarat Bayar')
			{
				$('#hide_nilai_list_syarat_bayar').show();
			}
		...
		else
		{
			...
			$('#hide_nilai_list_syarat_bayar').hide();
...
$("#btn_add").click(function(){
	...
	if(namaKolom == 'Syarat Bayar' && (operator == "Adalah" || operator == "Tidak mencakup"))
	{
		var value = $('#txt_nilai_list_syarat_bayar').val().split(" | ");
