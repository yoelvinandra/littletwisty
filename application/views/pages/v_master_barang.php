                    ...
                    "render" :function (data,display,row) 
    					{
    					    ...
    					    if(row.IDINDUKBARANGTIKTOK != 0)
    					    {
    					        if(logo != ""){logo += '<br>'}
    					        logo += '<img alt="Tiktok" style="width:60px;"src="https://upload.wikimedia.org/wikipedia/en/thumb/a/a9/TikTok_logo.svg/250px-TikTok_logo.svg.png">';
    					    }
                    ...
                    if(jenis != '')
                    {
                        ...
                        if(!$("#VARIANSET").prop('checked'))
                        {
                             $.ajax({
                                ...
                                success: function(msg){
                                    ...
                                    {
                                        indukBarangTiktok = msg.rows[0].IDINDUKBARANGTIKTOK;
                                        simpanHeaderTiktok();
                                    }
                        ...
                        else
                        {
                            ...
                            setTimeout(function() {
                                ...
                                {
                                    indukBarangTiktok = varian[0].IDINDUKBARANGTIKTOK;
                                    simpanHeaderTiktok();
                                }
                                else if(jenis == 'LAZADA')
                                {
            		     ...
            		     Swal.fire({
                                ...
                                //                 Swal.fire({
                            				...
                            				// 	});
                                                ...
                                                if(indukBarangShopee != 0 || indukBarangTiktok != 0 || indukBarangLazada != 0)
                                                {
