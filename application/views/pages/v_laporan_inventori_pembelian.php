        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Pembelian </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanPembelian" action='<?=base_url()?>Inventori/Laporan/LaporanPembelian/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-8">
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2" multiple="multiple" id="cbJenis" name="cbJenis[]" style="width:97%;">
                                                        <option value="BELI" selected>Pembelian</option>
                                                        <option value="RETUR" selected>Retur Pembelian</option>
                                                    </select>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2 " id="kolom" name="kolom" placeholder="Kolom" style="width:97%;">
														...
														<!--<option value="MSYARATBAYAR.KODESYARATBAYAR">Kode Syarat Bayar</option>-->
														<!--<option value="MSYARATBAYAR.NAMASYARATBAYAR">Nama Syarat Bayar</option>-->
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                   ...
                                                   <div id="hide_nilai_list_beli">
														<select id="txt_nilai_list_beli" class="form-control select2" name="txt_nilai_list_beli" style="width:97%" prompt="Nilai"/>
															<?=comboGrid("model_inventori_pembelian")?>
														</select>
													</div>
													
													<div id="hide_nilai_list_retur_beli" style="display:none;">
														<select id="txt_nilai_list_retur_beli" class="form-control select2" name="txt_nilai_list_retur_beli" style="width:97%" prompt="Nilai"/>
															<?=comboGrid("Model_inventori_returbeli")?>
														</select>
													</div>
													...
													<div id="hide_nilai_list_supplier" style="display:none;">
														<select id="txt_nilai_list_supplier" class="form-control select2" name="txt_nilai_list_supplier"style="width:97%" prompt="Nilai"/>
															<?=comboGrid("model_master_supplier")?>
														</select>
													</div>
													
													<div id="hide_nilai_list_syarat" style="display:none;">
														<select id="txt_nilai_list_syarat" class="form-control select2" name="txt_nilai_list_syarat" style="width:97%" prompt="Nilai"/>
															<?=comboGrid("model_master_syaratbayar")?>
														</select>
													</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group col-sm-4">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP','Laporan Rekap Pembelian')" style="cursor:pointer">
                                            ...
                                            <div class="info-box bg-yellow" onclick="simpan('REGISTER','Laporan Register Pembelian')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanPembelian">
...
$(document).ready(function(){
	...
	$("#kolom").change(function() {
		...
		if(checkData == "Kode" || checkData == "Nama" )
		{
			...
			else if(namaKolom == 'Syarat Bayar')
			{
				$('#hide_nilai_list_barang').hide();
				$('#hide_nilai_list_supplier').hide();
				$('#hide_nilai_list_beli').hide();
				$('#hide_nilai_list_retur_beli').hide();
				$('#hide_nilai_list_syarat').show();
			}
    ...
    $("#operatorNumber").change(function() {
	 ...
	 $("#btn_add").click(function() {
		...
		if (namaKolom == 'Supplier' && (operator == "Adalah" || operator == "Tidak mencakup")) {
			var value = $('#txt_nilai_list_supplier').val().split(" | ");
		...
		else if (namaKolom == 'Produk' && (operator == "Adalah" || operator == "Tidak mencakup")) {
        ...
        } else if (namaKolom == 'Syarat Bayar' && (operator == "Adalah" || operator == "Tidak mencakup")) {
			var value = $('#txt_nilai_list_syarat').val().split(" | ");
    ...
    function simpan(modeSimpan,tabLaporan) {
        $("#file_name").val("PEMBELIAN_"+modeSimpan+"_"+dateNowFormatExcel());
        var arraySimpan    = [];
