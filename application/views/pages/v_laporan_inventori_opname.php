        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Opname Stok </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanOpnameStok" action='<?=base_url()?>Inventori/Laporan/LaporanOpnameStok/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2 " id="kolom" name="kolom" placeholder="Kolom" style="width:97%;">
                                                        <option value="TOPNAMESTOK.KODEOPNAMESTOK">Kode Opname Stok Persediaan</option>		
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
													...
													<div id="hide_nilai_list_opname_stok_persediaan">
														<select id="txt_nilai_list_opname_stok_persediaan" name="txt_nilai_list_opname_stok_persediaan"  class="form-control select2"  style="width:97%;" prompt="Nilai"/>
															<?=comboGrid("model_inventori_opname")?>
														</select>
													</div>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="info-box bg-yellow" onclick="simpan('REGISTER','Laporan Opname Stok')" style="cursor:pointer;">
												...
												<div class="info-box-content">
												   ...
												   <span>Menampilkan transaksi disertai dengan detail barang dari transaksi tersebut.</span>
												</div>
												<!-- /.info-box-content -->
											</div>
											<div class="info-box bg-yellow" onclick="simpan('REGISTERBARANG','Laporan Opname Stok Per Barang')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>

												<div class="info-box-content">
												   <span class="info-box-number">Laporan Register Barang</span>
												   <span>Menampilkan transaksi disertai dengan detail barang diurutkan berdasarkan barang.</span>
												</div>
												<!-- /.info-box-content -->
											</div>
...
var kolom = "Kode Opname Stok Persediaan";
var namaKolom = "Opname Stok Persediaan";
var kolomVal = "TOPNAMESTOK.KODEOPNAMESTOK";
var checkData = "Kode";
var operator = "Adalah";
...
$("#kolom").change(function() {
	...
	if(checkData == "Kode" || checkData == "Nama" )
	{
		...
		if(namaKolom == 'Opname Stok Persediaan')
		{
			$('#hide_nilai_list_barang').hide();
			$('#hide_nilai_list_opname_stok_persediaan').show();
		}
		else if(namaKolom == 'Produk')
		{
			$('#hide_nilai_list_barang').show();
			$('#hide_nilai_list_opname_stok_persediaan').hide();
		}
...
$("#btn_add").click(function(){
	...
	//UNTUK KOLOM BESERTA COMBOGRID
	if(namaKolom == 'Opname Stok Persediaan' && (operator == "Adalah" || operator == "Tidak mencakup"))
	{
		nilai = $('#txt_nilai_list_opname_stok_persediaan').val();
		if(nilai != "" && nilai != null)
		{
			checknilai = 1;
		}
    ...
    function simpan(modeSimpan,tabLaporan) {
        var label = "";
        if(modeSimpan == "REGISTER")
        {
          label = "OPNAME_STOK_";
        }
        else
        {
          label = "OPNAME_STOK_BARANG_";  
        }
