        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Transfer </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanTransfer" action='<?=base_url()?>Inventori/Laporan/LaporanTransferPersediaan/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        <div class="form-group col-sm-8">
											...
											<div class="form-group">
                                                <label for="Lokasi">Group Lokasi Asal</label>
											...
											<div class="form-group">
                                                <label for="Lokasi">Group Lokasi Tujuan</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-map-marker"></i>
                                                    </div>
                                                    <select class="form-control"id="txt_group_lokasi_tujuan" name="txt_group_lokasi_tujuan" style="width:97%;">
													</select>
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2" multiple="multiple" id="txt_lokasi_tujuan" name="txt_lokasi_tujuan[]" placeholder="Lokasi..." style="width:97%;">
														<?=comboGrid("model_master_lokasi")?>
													</select>
											...
											<div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2 " id="kolom" name="kolom" placeholder="Kolom" style="width:97%;">
                                                        <option value="TTRANSFER.KODETRANSFER">Kode Transfer Persediaan</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
													...
													<div id="hide_nilai_list_transfer">
														<select id="txt_nilai_list_transfer" name="txt_nilai_list_transfer"  class="form-control select2"  style="width:97%;" prompt="Nilai"/>
															<?=comboGrid("model_inventori_transfer")?>
														</select>
													</div>
                                        ...
                                        <div class="form-group col-sm-4">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP','Laporan Rekap Transfer Stok')" style="cursor:pointer">
                                            ...
                                            <div class="info-box bg-yellow" onclick="simpan('REGISTER','Laporan Transfer Stok')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>
											...
											<div class="info-box bg-yellow" onclick="simpan('REGISTERBARANG','Laporan Transfer Stok per Barang')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>

												<div class="info-box-content">
												   <span class="info-box-number">Laporan Register Barang</span>
												</div>
												<!-- /.info-box-content -->
											</div>
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanTransfer">
									...
									<input type="hidden" id="group_lokasi_tujuan" name="group_lokasi_tujuan">
                                    <!-- /.box-body -->
                                </form>
                                <!-- Button -->
                            </div>
...
$(document).ready(function(){
    ...
    $.ajax({
    	...
    	success : function(msg){
    		...
    		for(var x = 0 ; x < msg.rows.length ; x++)
    		{
    		    ...
    		    $("#txt_group_lokasi_tujuan").append('<option value="'+msg.rows[x].VALUE+'">'+msg.rows[x].TEXT+'</option>');
    		}
    ...
    $("#txt_group_lokasi_tujuan").click(function() {
    
        if($("#txt_group_lokasi_tujuan").val() == "")
        {
            $("#txt_lokasi_tujuan").val([]);
            $('#txt_lokasi_tujuan').trigger('change');
        }
        else
        {
            var arrLokasi = $("#txt_group_lokasi_tujuan").val().split(",");
            $("#txt_lokasi_tujuan").val(arrLokasi);
            $('#txt_lokasi_tujuan').trigger('change');
        }
        $("#group_lokasi_tujuan").val($("#txt_group_lokasi option:selected").text());
    })
    
    $("#txt_lokasi_tujuan").on('change',function() {
         var arrLokasi = $(this).val();
         var valueLokasi = "";
         for(var x = 0 ; x < arrLokasi.length ; x++)
         {
         ...
         $("#txt_group_lokasi_tujuan").val(valueLokasi);
         $('#txt_group_lokasi_tujuan').trigger('change');
        $("#group_lokasi_tujuan").val($("#txt_group_lokasi option:selected").text());
    })
...
//TAMBAH FILTER
	$("#btn_add").click(function() {
        ...
        } else if (namaKolom == 'Transfer Persediaan' && (operator == "Adalah" || operator == "Tidak mencakup")) {
            nilai = $('#txt_nilai_list_transfer').val();
            if (nilai != "" && nilai != null) {
                checknilai = 1;
            }
	...
	function simpan(modeSimpan,tabLaporan) {
	    ...
	    if(modeSimpan == "REKAP")
        {
          label = "TRANSFER_STOK_REKAP_";
        }
        else if(modeSimpan == "REGISTER")
        {
          label = "TRANSFER_STOK_";
        }
        else
        {
          label = "TRANSFER_STOK_BARANG_";  
        }
        $("#file_name").val(label+dateNowFormatExcel());
    
        var arraySimpan = [];
        var lokasi = $('#txt_lokasi').val();
        var lokasiTujuan = $('#txt_lokasi_tujuan').val();
        ...
        if(lokasi != "" && lokasiTujuan != "" && jenistransaksi != ""){
        ...
        {
        	alert('Asal Lokasi Tidak Boleh Kosong');
        }
        else
        {
        	alert('Tujuan Lokasi Tidak Boleh Kosong');
        }
