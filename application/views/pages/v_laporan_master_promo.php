        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Master Supplier </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanSupplier" action='<?=base_url()?>Master/Laporan/LaporanSupplier/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-sm-6">
											...
											<div class="info-box bg-yellow" onclick="simpan('REKAP')" style="cursor:pointer">
												...
												<div class="info-box-content">
												  <span class="info-box-number">Laporan Supplier</span>
												  <span>Menampilkan data dari supplier yang sudah pernah dibuat.</span>
												</div>
												<!-- /.info-box-content -->
											</div>	
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanSupplier">
