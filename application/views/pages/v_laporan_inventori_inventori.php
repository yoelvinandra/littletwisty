        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h3 class="box-title" style="font-size:20pt;">Laporan Inventori </h3> <button class="btn pull-right" id="btn_print" style="font-size:20pt;"><i class="fa fa-print" ></i></button>
                ...
                <div >
                    ...
                    <div class="tab-content" id="tab-report">
                        <div class="tab-pane active" id="tab_form">
                            ...
                            <div class="col-sm-12">
                                <!-- form start -->
                                <form method='post' target="LaporanSaldoStok" action='<?=base_url()?>Inventori/Laporan/LaporanInventori/laporan<?='?kode='.$kodemenu?>' id="form_input">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="info-box bg-yellow" onclick="simpan('kategori','Laporan Inventori Produk')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>

												<div class="info-box-content">
												   <span class="info-box-number">Laporan Register Berd Produk</span>
												   <span>Menampilkan transaksi berdasarkan nama Produk tersebut.</span>
												</div>
												<!-- /.info-box-content -->
											</div>
											<div class="info-box bg-yellow" onclick="simpan('barang','Laporan Inventori Varian')" style="cursor:pointer;">
												<span class="info-box-icon"><i class="ion ion-ios-book-outline" style="margin-top:20%; font-size:40pt;"></i></span>

												<div class="info-box-content">
												   <span class="info-box-number">Laporan Register Berd Varian</span>
												   <span>Menampilkan transaksi berdasarkan Varian tersebut.</span>
												</div>
												<!-- /.info-box-content -->
											</div>
									...
									<!-- NAMA LAPORAN -->
									<input type="hidden" name="file_name" id="file_name" value="LaporanInventori">
...
function simpan(modeSimpan,tabLaporan) {
    ...
    $("#file_name").val("INVENTORI_"+label+"_"+dateNowFormatExcel());
    var arraySimpan = [];
