...
?>
	...
	';?>
		...
		$footer='
				...
				<td valign="top"colspan="2" rowspan="2" valign="top">
    				...
    				<td valign="top" colspan="2" >
        				...
        				<table width="100%" style="margin-top:2px;">
        					<tr valign="top">
        					<td class="font-body " colspan="3"><b>Bank Transfer</b><br>BCA 8290883106<br>KARATU ABADI JAYA CV</td>
        					</tr>
        				</table>
    				</td>
	    	...
	    	<img src="'.base_url().'assets/'.$_SESSION[NAMAPROGRAM]['KODEPERUSAHAAN'].'/TTNOTA.png" width="150" style="float:right;">
			</div>
