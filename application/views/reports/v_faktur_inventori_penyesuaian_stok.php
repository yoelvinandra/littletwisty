...
<html>
<head>
<title> ..:: Faktur Bukti Penyesuaian Stok ::.. </title>
...
$sql = "select a.*,b.KODEOPNAMESTOK,c.KODELOKASI,c.NAMALOKASI
				from TPENYESUAIANSTOK a 
				left join TOPNAMESTOK b on a.IDOPNAMESTOK=b.IDOPNAMESTOK  and a.idperusahaan = b.idperusahaan
 				inner join MLOKASI c on a.IDLOKASI = c.IDLOKASI  and a.idperusahaan = c.idperusahaan
			where a.IDPENYESUAIANSTOK = ? && a.idperusahaan = ".$perusahaan."";
	...
	<tr valign="top">
		...
		<table border="0" class="tabel_perusahaan">
			<tr>
				...
				<td valign="top" rowspan="3" class="title"> PENYESUAIAN STOK </td>
			...
			<table border="0">
				<tr>
					<td valign="top"valign="top" class="info_transaksi">
						<table border="0" class="fieldset info_transaksi">
							<tr valign="top"><td>
							<table>
								<tr>
									<td valign="top"class="font-header" >No. Penyesuaian Stok</td>
									<td valign="top"class="font-body">: <?= $r->KODEPENYESUAIANSTOK ?></td>
								</tr>
								<tr>
									<td valign="top"class="font-header">Tgl Penyesuaian Stok </td>
		...
		$sql = "select a.*,b.KODEBARANG, b.NAMABARANG
				...
				inner join TPENYESUAIANSTOK a1 on a.IDPENYESUAIANSTOK = a1.IDPENYESUAIANSTOK  and a.idperusahaan = a1.idperusahaan
				inner join MBARANG b on a.IDBARANG = b.IDBARANG  and a.idperusahaan = b.idperusahaan
				where a.IDPENYESUAIANSTOK = '{$idtrans}' && a.idperusahaan = ".$perusahaan." order by a.URUTAN";
		...
		?>
			...
			<tr>
				...
				<?php }?>
				<th class="center kode tbl-header border-atas border-bawah border-kanan" >Kode Barang</th>
				<th class="center tbl-header border-atas border-bawah border-kanan" width="300">Nama</th>
				<th class="center satuan tbl-header border-atas border-bawah border-kanan">Selisih</th>                                    
			...
			?>
				<tr>
					...
					<td valign="top"class="border-kanan center font-body "><?=$rs->KODEBARANG?></td>
					<td valign="top"class="border-kanan font-body "><?=$rs->NAMABARANG?></td>
					<td valign="top"class=" center font-body border-kanan"><?=number($rs->SELISIH, true, $_SESSION[NAMAPROGRAM]['DECIMALDIGITQTY'])?></td>
			...
			<tr>
					...
					<td  valign="top" class="border-kanan border-bawah"></td>
