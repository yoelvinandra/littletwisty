...
<body>
	...
	<div id="header">Laporan Lokasi</div>
	<?php
	$tbl = new html_table();
	...
	$tbl->set_th(array(
		array('id'=>'detail', 'class'=>'tebal', 'align'=>'center', 'width'=>'70', 'values'=>'Kode'),
		array('id'=>'detail', 'class'=>'tebal', 'align'=>'center', 'width'=>'250', 'values'=>'Nama'),
	...
	foreach($query as $item) {
		...
		$tbl->set_td(array(
			array('id'=>'detail', 'values'=>$item->KODELOKASI),
			array('id'=>'detail', 'values'=>$item->NAMALOKASI),
