...
<html>
<head>
<title> ..:: Faktur Pembelian Retur ::.. </title>
...
//$transaksi = $CI->model_master_config->getConfig('TRETURBELI','TRANSAKSIBELI');

$sql = "select a.*,f.IDSYARATBAYAR,f.SELISIH,b.KODELOKASI,b.NAMALOKASI,c.KODESUPPLIER,c.NAMASUPPLIER,c.BADANUSAHA,
				c.ALAMAT as ALAMATSUPPLIER,
				d.USERNAME,e.USERNAME as USERBATAL
				from TRETURBELI a
				...
				left join MUSER e on a.USERBATAL = e.USERID  and a.idperusahaan = e.idperusahaan
				left join MSYARATBAYAR f on a.IDSYARATBAYAR = f.IDSYARATBAYAR  and a.idperusahaan = f.idperusahaan
...
if($transaksi == "HEADER")
{
	$transheader='<tr>
		...
		<td valign="top"class="font-body">: '.$r->KODEBELI.' &nbsp </td>
	</tr>';
}
...
if($transaksi == "DETAIL")
{
	$transdetail='<th class="center tbl-header border-atas border-bawah border-kanan" width="15%">No.Beli</th>';
...
?>
		...
		<table style="width:620px;">
			<table border="0" class="tabel_perusahaan">
				<tr>
					...
					<td valign="top" rowspan="3" class="title"> RETUR PEMBELIAN</td>
					...
					<td valign="top"valign="top" class="info_transaksi">
							...
							<table>
								<tr>
									...
									<td valign="top"class="font-body">: '.$r->KODERETURBELI.'</td>
								</tr>
								...
								'.$transheader.'
								<tr>
									<td valign="top"class="font-header">&nbsp;</td>
								</tr>
							</table>
							</td></tr>
							</table>
		...
		$sql = "select distinct a.KODERETURBELI,a.IDBBK,a.ADANPWP,
				...
				a.JML,a.JMLBONUS,a.SATUAN,a.IDCURRENCY, d.SIMBOL,a.HARGA,a.DISCPERSEN,a.DISC,a.DISCKURS,a.SUBTOTAL,a.NILAIKURS,a.HARGAKURS,a.SUBTOTALKURS,a.URUTAN,a.PAKAIPPN,a.PPNPERSEN,a.PPNRP
				from TRETURBELIDTL a 
				left join TRETURBELI a1 on a.IDRETURBELI = a1.IDRETURBELI  and a.idperusahaan = a1.idperusahaan
		...
		$footer='<tr>
			...
			<tr>
					...
					<td valign="top"colspan="3" valign="top">
						<table width="100%" >
							<tr>
								<td valign="top"class="font-header  right" width="57%">Total</td>
		...
		?>
			...
			<tr>
				...
				<td valign="top"class="font-body border-kanan center" valign="top"><?=$rs->KODEBELI?></td>
				<?php }?>
		...
		?>
						<tr>
							<td valign="top"class=" border-kanan border-kiri ">&nbsp;</td>
							<td valign="top"class=" border-kanan">&nbsp;</td>
							<td valign="top"class=" border-kanan">&nbsp;</td>
							<td valign="top"class=" border-kanan">&nbsp;</td>
							<td valign="top"class=" border-kanan">&nbsp;</td>
							<td valign="top"class=" border-kanan">&nbsp;</td>
