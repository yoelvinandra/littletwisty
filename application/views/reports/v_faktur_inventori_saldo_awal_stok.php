...
<html>
<head>
<title> ..:: Faktur Bukti Saldo Awal Stok ::.. </title>
...
$sql = "select a.*,b.KODELOKASI,b.NAMALOKASI,c.USERNAME as USERENTRY,d.USERNAME as USERBATAL
				from SALDOSTOK a
			...
			where a.IDSALDOSTOK = ? && a.idperusahaan = ".$perusahaan."";
	...
	<tr valign="top">
		...
		<table border="0" class="tabel_perusahaan" >
			<tr>
				...
				<td valign="top" rowspan="3" class="title"> SALDO AWAL STOK </td>
			...
			<table border="0" >
				<tr>
					<td  valign="top" valign="top" class="info_transaksi">
							...
							<table>
								<tr>
									<td valign="top"class="font-header" >No. Saldo Stok</td>
									<td valign="top"class="font-body">: <?= $r->KODESALDOSTOK ?></td>
								</tr>
		...
		$sql = "select a.*,b.KODEBARANG, b.NAMABARANG
				from SALDOSTOKDTL a
				inner join SALDOSTOK a1 on a.IDSALDOSTOK = a1.IDSALDOSTOK  and a.idperusahaan = a1.idperusahaan
				inner join MBARANG b on a.IDBARANG = b.IDBARANG  and a.idperusahaan = b.idperusahaan
				where a.IDSALDOSTOK = {$idtrans} && a.IDPERUSAHAAN = {$_SESSION[NAMAPROGRAM]['IDPERUSAHAAN']} order by a.URUTAN";
		...
		?>
			...
			?>
				<tr>
					<td valign="top"class="border-kiri border-kanan">&nbsp;</td>
