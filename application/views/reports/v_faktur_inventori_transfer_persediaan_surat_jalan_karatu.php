				...
				<table border="0">
					...
					<td valign="top"valign="top" class="info_transaksi">
								...
								<table>
									'.$transheader.'
									<tr>
										<td valign="top"class="font-header">No. Surat Jalan</td>
						...
						<td valign="top"valign="top" class="customer">
									...
									<table>
										<tr>
											...
											<td valign="top"class="font-body">: </td>
											<td valign="top"class="font-body">
											    HARAP PERIKSA KELENGKAPAN BARANG DENGAN SURAT JALAN. APABILA TIDAK ADA KOMPLAIN, KAMI AKAN MENGANGGAP BAHWA SURAT JALAN KAMI SUDAH BENAR DAN SESUAI
											    <br><br>
											    '.$r->CATATAN.' 
										    </td>
										</tr>
