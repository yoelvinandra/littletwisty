...
<body>
	<div >
<?php
cetak_header($title,$lokasi,$tgl_aw,$tgl_ak);
if ($tampil=='REGISTER') {  	
	...
	$this->html_table->set_th(array(
		...
		array('align'=>'center', 'id'=>'tabelket', 'width'=>120, 'values'=>'No. Invoice Supplier'),
		array('align'=>'center', 'id'=>'tabelket', 'width'=>120, 'values'=>'No. Trans Referensi'),
		...
		array('align'=>'center', 'id'=>'tabelket', 'width'=>80,  'values'=>'PPH22 ('.$_SESSION[NAMAPROGRAM]['SIMBOLCURRENCY'].')'),
		array('align'=>'center', 'id'=>'tabelket', 'width'=>70,  'values'=>'Pembulatan ('.$_SESSION[NAMAPROGRAM]['SIMBOLCURRENCY'].')'),
		array('align'=>'center', 'id'=>'tabelket', 'width'=>100, 'values'=>'Grandtotal ('.$_SESSION[NAMAPROGRAM]['SIMBOLCURRENCY'].')'),
		...
		array('align'=>'center', 'id'=>'tabelket', 'width'=>80,  'values'=>'Harga Include PPN ('.$_SESSION[NAMAPROGRAM]['SIMBOLCURRENCY'].')'),//array('align'=>'center', 'id'=>'tabelket', 'width'=>60,  'values'=>'Kurs ('.$_SESSION[NAMAPROGRAM]['SIMBOLCURRENCY'].')'),
		//array('align'=>'center', 'id'=>'tabelket', 'width'=>80,  'values'=>'Harga ('.$_SESSION[NAMAPROGRAM]['SIMBOLCURRENCY'].')'),
	...
	foreach($query as $r) {
		...
		if ($kodetrans!=$r->KODETRANS) {
			...
			$a_merge = array(
				...
				array('valign'=>'top',  'align'=>'center', 'class'=>'det', 'bgcolor'=>$warna2, 'values'=>$r->NOINVOICESUPPLIER),
			...
			$a_merge2 = array(
				array('valign'=>'top',  'align'=>'left',   'class'=>'det', 'bgcolor'=>$warna2, 'values'=>$r->KETERANGAN),
			);
		...
		if($r->PAKAIPPN == 1)
		{	
			$HARGAPPN = array('class'=>'det', 'valign'=>'top','bgcolor'=>'yellow', 'align'=>'right', 'values'=>$LIHATHARGA?number($r->HARGA+($r->PPNBARANG/$r->JML),true,$_SESSION[NAMAPROGRAM]['DECIMALDIGITAMOUNT']):'X');
		}
		else
		{
			$HARGAPPN = array('class'=>'det', 'valign'=>'top','bgcolor'=>'yellow', 'align'=>'right', 'values'=>$LIHATHARGA?number($r->HARGA,true,$_SESSION[NAMAPROGRAM]['DECIMALDIGITAMOUNT']):'X');
		}
		$this->html_table->set_tr();
		$this->html_table->set_td(array_merge(
			$a_merge,
			array(
				array('class'=>'det', 'valign'=>'top','bgcolor'=>$warna, 'align'=>'center', 'values'=>$r->KODEBARANG),
				array('class'=>'det', 'valign'=>'top','bgcolor'=>$warna, 'values'=>$r->NAMABARANG),
				array('class'=>'det', 'valign'=>'top','bgcolor'=>$warna, 'align'=>'center', 'values'=>$r->SATUAN),
				array('class'=>'det', 'valign'=>'top','bgcolor'=>$warna, 'align'=>'right', 'values'=>number($r->JML, true,$_SESSION[NAMAPROGRAM]['DECIMALDIGITQTY'])),
				//array('class'=>'det', 'bgcolor'=>$warna, 'align'=>'center', 'values'=>$r->SIMBOL),
				array('class'=>'det', 'valign'=>'top','bgcolor'=>$warna, 'align'=>'right', 'values'=>$LIHATHARGA?number($r->HARGA,true,$_SESSION[NAMAPROGRAM]['DECIMALDIGITAMOUNT']):'X'),
				$HARGAPPN,
				...
				array('class'=>'det', 'valign'=>'top','bgcolor'=>$warna, 'align'=>'right', 'values'=>$LIHATHARGA?number($KetDisc,true,$_SESSION[NAMAPROGRAM]['DECIMALDIGITAMOUNT']):'X'),
				array('class'=>'det', 'valign'=>'top','bgcolor'=>$warna, 'align'=>'right', 'values'=>$LIHATHARGA?number($diskon,true,$_SESSION[NAMAPROGRAM]['DECIMALDIGITAMOUNT']):'X'),
				array('class'=>'det', 'valign'=>'top','bgcolor'=>$warna, 'align'=>'right', 'values'=>$LIHATHARGA?number($r->SUBTOTALKURS,true,$_SESSION[NAMAPROGRAM]['DECIMALDIGITAMOUNT']):'X'),
			),
			$a_merge2
		));
	...
	$this->html_table->set_td(array(
		array('align'=>'right', 'colspan'=>6, 'id'=>'tabelket', 'values'=>'Grand Total'),
		...
		array('align'=>'right', 'colspan'=>10, 'id'=>'tabelket','values'=>'' ),
	));
	...
	$this->html_table->set_th(array(
		...
		array('align'=>'center', 'id'=>'tabelket', 'width'=>120, 'values'=>'No. Trans'),
		array('align'=>'center', 'id'=>'tabelket', 'width'=>120, 'values'=>'No. Invoice Supplier'),
		array('align'=>'center', 'id'=>'tabelket', 'width'=>120, 'values'=>'No. PO'),
...
<?php
function cetak_header($title,$lokasi,$tglAw, $tglAk) {
